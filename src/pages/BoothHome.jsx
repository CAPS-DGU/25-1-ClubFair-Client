      ...
      <div className="booth-container">
        ...
        <div className="booth-add-wiki">
          <button className="booth-add-wiki-btn">
            <p>위키 추가하기</p>
            <img src="/src/assets/add-wiki.svg" alt="add wiki" className="wiki-icon" />
          </button>
        </div>
        ...
        <footer className="booth-footer">
          <a><img className="booth-footer-icon" src="/src/assets/github.svg" alt="GitHub" /></a>
          <a><img className="booth-footer-icon" src="/src/assets/instagram.svg" alt="Instagram" /></a>
          <a><img className="booth-footer-icon" src="/src/assets/email.svg" alt="Email" /></a>
          <a><img className="booth-footer-icon" src="/src/assets/apply.svg" alt="Apply" /></a>
        </footer>
      </div>
    );
  }