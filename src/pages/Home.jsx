    ...
    <div className="home-container">
      ...
      <main className="home-content">
        ...
        <p className="home-desc">
          ...
          <br /> 3월 5일부터 9일까지 운영됩니다. '캡스위키'에서 실제 사용하는
          캡스위키를 동아리 박람회 용도에 맞게 배포했습니다.
        </p>
        <div className="home-search-box">
          <a><img src="/src/assets/search.svg" alt="search" className="home-search-icon" /></a>
  ...
  return (
    <div className="mobile-container">
      ...
      <p className="home-desc">
        ...
        <br /> 동박위키는 실제 캠스에서 사용하는 캡스위키를 동아리 박람회 용도에 맞게 변형했습니다.
      </p>
      <div className="home-search-box">
        <img src="/src/assets/search.svg" alt="search" className="home-search-icon" />
        <input type="text" placeholder="찾고싶은 인물의 이름을 검색해주세요!" />
      </div>
      ...
      <footer className="mobile-footer">
        <a src="" target="_blank"><img className="footer-icon" src="/src/assets/github.svg" alt="GitHub" /></a>
        <a src="" target="_blank"><img className="footer-icon" src="/src/assets/instagram.svg" alt="Instagram" /></a>
        <a src="" target="_blank"><img className="footer-icon" src="/src/assets/email.svg" alt="EEmail" /></a>
        <a src="" target="_blank"><img className="footer-icon" src="/src/assets/apply.svg" alt="AApply" /></a>
      </footer>
