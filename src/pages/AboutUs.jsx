      ...
      <div className="mobile-container">
        ...
        <div className="mobile-grid">
          <div className="mobile-box">
            <span className="position">PM</span>
            <br />
          ...
          <div className="mobile-box">
            <span className="position">개발팀장</span>
            <br />
          ...
          <div className="mobile-box">
            <span className="position">회장</span>
            <br />
          ...
          <div className="mobile-box">
            <span className="position">부회장</span>
            <br />
          ...
          <div className="mobile-box">
            <span className="position">편집부장</span>
            <br />
